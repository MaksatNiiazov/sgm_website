...
export const infoPages: Record<string, InfoPage> = {
  ...
  earnings: {
    ...
    intro:
      "Models on the platform earn at different levels. Some established profiles earn $12,000+ NZD per month, while the reported average for active models is typically around $5,000–7,000 NZD per month. Results depend on schedule, presentation, communication and consistency.",
    ruIntro:
      "Модели на платформе зарабатывают по-разному. Отдельные сильные профили получают $12,000+ NZD в месяц, а средний ориентир для активных моделей обычно находится в районе $5,000–7,000 NZD в месяц. Результат зависит от графика, подачи, коммуникации и стабильности.",
    points: [
      ...
      "Some established models earn $12,000+ NZD per month through strong consistency, premium positioning and a schedule that fits audience demand.",
      ...
      "The $5,000–7,000 NZD figure is an indicative average for active models, not a guaranteed result; your personal offer is based on your starting point and fit.",
    ],
    ruPoints: [
      ...
      "Отдельные сильные модели зарабатывают $12,000+ NZD в месяц благодаря стабильной работе, премиальному позиционированию и графику, который подходит аудитории.",
      ...
      "Диапазон $5,000–7,000 NZD является ориентиром средней зарплаты активных моделей, а не гарантией: личный оффер зависит от стартовой точки и соответствия формату.",
    ],
